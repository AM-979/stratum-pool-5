...
//    }
   ...
   //console.log( bitcoin.Block.calculateMerkleRoot(rpcData.transactions, rpcData.default_witness_commitment));
   //console.log(txHex);
...
//  txHex += util.packUInt32LE(txHex);

    //bitcoin.Block.calculateMerkleRoot(rpcData.merkleroot);
//    console.log(txHex);
    return txHex;
};
