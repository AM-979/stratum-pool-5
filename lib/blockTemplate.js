...
//yeah boi  testing
//    console.log(this.rpcData.founder);
    this.jobId = jobId;
    ...
    //founder  added derp as 
    //var founder = [];
    //rpcData.founder.forEach(function(value) {
    //    founder.push(value);
    //});
    var founder = this.rpcData.founder;
    var coinbasePayload = this.rpcData.coinbase_payload;

    if (typeof this.genTx === 'undefined') {
        //console.log(rpcData.founder);
        this.genTx = transactions.createGeneration(rpcData, blockReward, this.rewardFees, recipients, poolAddress, rpcData.founder).toString('hex');
        //console.log(this.genTx = transactions.createGeneration(rpcData, blockReward, this.rewardFees, recipients, poolAddress, rpcData.founder));
